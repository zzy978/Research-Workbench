...
```python
from deepresearch_agent.cache_manager import (
    CacheManager,
...
```python
from deepresearch_agent.cache_manager import CacheManager, SimpleCacheKeyStrategy
...
```python
from deepresearch_agent.cache_manager import CacheManager, ContextAwareCacheKeyStrategy
...
```python
from deepresearch_agent.cache_manager import CacheManager, ContextAndKeywordAwareCacheKeyStrategy
...
```python
from deepresearch_agent.cache_manager import CacheManager, GlobalCacheKeyStrategy
...
```python
from deepresearch_agent.cache_manager import DiskCacheBackend, CacheManager
...
```python
from deepresearch_agent.cache_manager import initialize_model_cache, ensure_model_cache_dir
...
```python
# deepresearch_agent/config/settings.py
CACHE_SETTINGS = {
