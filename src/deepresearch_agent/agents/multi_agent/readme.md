...
```python
from deepresearch_agent.agents.multi_agent.integration import (
    MultiAgentFactory,
    MultiAgentFacade,
)
from deepresearch_agent.agents.multi_agent.planner import PlannerConfig
from deepresearch_agent.agents.multi_agent.reporter import ReporterConfig
